sap.ui.define([
	...
	return BaseController.extend("demotemp.controller.Master", {
		...
		onInit : function () {
			...
			this._oGroupFunctions = {
				ShipVia : function(oContext) {
					var iNumber = oContext.getProperty('ShipVia'),
						key, text;
					if (iNumber <= 20) {
						key = "LE20";
		...
		onOpenViewSettings : function (oEvent) {
			...
			if (!this.byId("viewSettingsDialog")) {
				Fragment.load({
					...
					name: "demotemp.view.ViewSettingsDialog",
					controller: this
		...
		onConfirmViewSettingsDialog : function (oEvent) {
			...
			aFilterItems.forEach(function (oItem) {
				switch (oItem.getKey()) {
					case "Filter1" :
						aFilters.push(new Filter("ShipVia", FilterOperator.LE, 100));
						break;
					case "Filter2" :
						aFilters.push(new Filter("ShipVia", FilterOperator.GT, 100));
						break;
					default :
						break;
				}
